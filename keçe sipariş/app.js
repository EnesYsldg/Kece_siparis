      ...
      <div class="col-6 d-flex flex-column justify-content-between">
        <div class="book__detail">
          ...
          <span class="book__star-rate">
            ...
            <span class="gray">${book.reviewCount} Değerlendirme</span>
          </span>
        </div>
...
const listBasketItems = () => {
  ...
  basketList.forEach((item) => {
    ...
    basketListHtml += `<li class="basket__item">
        ...
        <div class="basket__item-info">
          ...
          <span class="book__remove" onclick="removeItemToBasket(${item.product.id})">Ürünü Kaldır</span>
        </div>
  ...
  basketListEl.innerHTML = basketListHtml
    ? basketListHtml
    : `<li class="basket__item">Sepette ürün yok, Lütfen ürün ekleyin...</li>`;
  totalPriceEl.innerHTML =
    totalPrice > 0 ? "Toplam Tutar: : " + totalPrice.toFixed(2) + "₺" : null;
};
  ...
  if (findedBook) {
    ...
    if (basketAlreadyIndex == -1) {
      ...
      if (
        ...
        toastr.error("Stokta ürün kalmadı");
        return;
      }
    }
    listBasketItems();
    toastr.success("Keçe sepete eklendi");
  }
};
